   ...
   <center>
       <div class="loginbox1">
        ...
        <form method="POST" action="index.php">
            <p>MSISDN</p>
                <input type="text" id='MSISDN' name='MSISDN' value="<?php echo $MSISDN; ?>" autocomplete="off" placeholder="ex: 62812xxxxxxx">
            <p>ADN</p>
                <input type="text" id='ADN' name='ADN' value="<?php echo $ADN; ?>" autocomplete="off">
            <p>KEYWORD</p>
                <input type="text" id='keyword' name='keyword' value="<?php echo $keyword; ?>" autocomplete="off">
            <p>TICKET NUMBER</p>
                <input type="text" id='ticketNumber' name='ticketNumber' value="<?php echo $ticketNumber; ?>" autocomplete="off">
